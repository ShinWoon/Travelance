...
public class TravelController {
    ...
    public ResponseEntity<RoomIdResponseDto> MakeRoom(@MemberInfo MemberInfoDto memberInfo, @RequestPart(value = "imageFiles") MultipartFile profileUrl, @RequestPart RoomInfoRequestDto roomInfoRequestDto, @RequestBody RoomUserRequestDto roomUserRequestDto) {
        Member member = memberService.findMemberByEmail(memberInfo.getEmail());
        RoomIdResponseDto responseDto= travelService.save(roomInfoRequestDto, member, profileUrl, roomUserRequestDto);
    ...
    public ResponseEntity <ResultDto> AddUser(@MemberInfo MemberInfoDto memberInfo, @RequestPart(value = "imageFiles") MultipartFile profileUrl, @RequestPart RoomUserRequestDto roomUserRequestDto, @PathVariable Long roomId) {
        Member member = memberService.findMemberByEmail(memberInfo.getEmail());
