...
public class TravelController {
    ...
    public ResponseEntity <ResultDto> AddUser(@MemberInfo MemberInfoDto memberInfo, @RequestPart(value = "imageFiles") MultipartFile profileUrl, @PathVariable Long roomId) {
        Member member = memberService.findMemberByEmail(memberInfo.getEmail());
