...
public class TravelController {
    ...
    @PostMapping(value = "")
    public ResponseEntity<RoomIdResponseDto> MakeRoom(@MemberInfo MemberInfoDto memberInfo, @RequestPart RoomInfoRequestDto roomInfoRequestDto,  @RequestPart(value = "imageFiles") MultipartFile imageFiles, @RequestBody RoomUserRequestDto roomUserRequestDto) {
