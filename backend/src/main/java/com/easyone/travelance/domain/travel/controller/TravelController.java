...
public class TravelController {
    ...
    public ResponseEntity<RoomIdResponseDto> MakeRoom(@MemberInfo MemberInfoDto memberInfo, @RequestPart(value = "imageFiles") MultipartFile profileUrl, @RequestPart RoomInfoRequestDto roomInfoRequestDto) {
