...
public class TravelController {
    ...
    @PostMapping(value = "")
    public ResponseEntity<RoomIdResponseDto> MakeRoom(@MemberInfo MemberInfoDto memberInfo, @RequestPart(value = "imageFiles", required = false) MultipartFile profileUrl, @RequestBody RoomInfoRequestDto roomInfoRequestDto) {
