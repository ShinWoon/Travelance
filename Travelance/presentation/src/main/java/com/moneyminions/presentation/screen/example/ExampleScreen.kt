package com.moneyminions.presentation.screen.example
...
import com.moneyminions.presentation.viewmodel.example.ExampleViewModel
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CardRepo(repo: ExampleDto, onClick: () -> Unit){
    Card(
...
@Composable
fun CardRepoPreview(){
    CardRepo(repo = ExampleDto(1,"name","htmlUrl","url","gitUrl"), onClick = {})
}
